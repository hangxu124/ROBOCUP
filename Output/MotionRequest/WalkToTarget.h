 ...
 */
option(WalkToTarget, (const Pose2f&) speed, (const Pose2f&) target ,(int) (1) enableCollisionAvoidance)
{
  ...
  target_state(requestIsExecuted)
  {
    ...
    action
    {
      ...
      if (enableCollisionAvoidance == 1){
          Vector2f targetPositionCorrected = libCodeRelease.AvoidObstacles(target.translation); //alter path so as to avoid obstacles
